...
const MainDashboard = () => {
  ...
  // Infinite scroll effect - improved for mobile compatibility
  useEffect(() => {
    const handleScroll = () => {
      // Use a threshold approach that works better on mobile
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="hidden md:flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative profile-dropdown">
                ...
                {showProfileDropdown && (
                  <div className="absolute right-0 top-full mt-2 w-48 bg-gray-800/95 backdrop-blur-md border border-white/10 rounded-lg shadow-2xl py-2 z-[9999]">
          ...
          <div className="md:hidden">
            ...
            <div className="flex items-center justify-between mb-4">
              <h1 
                className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 cursor-pointer"
                onClick={() => navigate('/')}
              >
                MoView
              </h1>
            ...
            <div className="w-full">
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Search for movies..."
                  className="w-full px-4 py-3 pr-16 bg-white/10 border border-white/20 rounded-full text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent backdrop-blur-sm text-sm"
                />
                {searchQuery && (
                  <button
                    type="button"
                    ...
                    className="absolute right-12 top-1/2 transform -translate-y-1/2 w-6 h-6 text-gray-400 hover:text-white transition-colors duration-300"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-4 h-4">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                    </svg>
                ...
                <button
                  type="submit"
                  disabled={searchLoading}
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full hover:from-purple-500 hover:to-pink-500 transition-all duration-300 disabled:opacity-50"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
